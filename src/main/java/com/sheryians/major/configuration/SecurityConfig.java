	...
	CustomUserDetailService customUserDetailService;
	    ...
	    protected void configure(HttpSecurity http) throws Exception {
	        http.authorizeRequests()
	            .antMatchers("/h2-console/**","/","/shop/**","/register").permitAll() // Allow H2 console access
	            .antMatchers("/admin/**").hasRole("ADMIN")
	            .anyRequest().authenticated()
//	            .and().csrf().ignoringAntMatchers("/h2-console/**") // Disable CSRF for H2 console
//	            .and().headers().frameOptions().sameOrigin(); // Allow framing of H2 console
	            .and()
	            .formLogin()
	            .loginPage("/login")
	            .permitAll()
